...
class DocumentProcessor:
    ...
    def chunk_text(self, text: str, source: str, category: str = "general") -> List[Dict[str, Any]]:
        """
    ...
    def save_index_and_metadata(self, index: faiss.Index, chunks: List[Dict[str, Any]]) -> None:
        """
