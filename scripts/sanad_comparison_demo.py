...
class SanadComparisonDemo:
    def __init__(self):
        ...
        self.mock_verifications = {
            "high": {
                ...
                "precision": {"score": 0.90, "accuracy": "High alignment with source documents"},
                "provenance": {"score": 0.88, "sources": ["Labour Law Article 18", "Ministry Decree 2023"]},
                "domain": {"score": 0.94, "expertise": "Labour law domain verified"}
            },
            "medium": {
                "score": 0.75,
                "integrity": {"score": 0.78, "issues": ["Minor inconsistency in date format"]},
                "precision": {"score": 0.72, "accuracy": "Generally accurate with minor gaps"},
                "provenance": {"score": 0.70, "sources": ["Research report TMO-Q4"]},
                "domain": {"score": 0.80, "expertise": "Domain relevant"}
            },
            "low": {
                "score": 0.45,
                "integrity": {"score": 0.40, "issues": ["Potential outdated information", "Conflicting sources"]},
                "precision": {"score": 0.48, "accuracy": "Several inaccuracies detected"},
    ...
    def _enhance_answer(self, baseline_answer: str, sources: List[Dict], verification: Dict) -> str:
        ...
        if verification["score"] >= 0.8:
            ...
            if verification["integrity"]["issues"]:
                enhanced += "\n- Issues: " + ", ".join(verification["integrity"]["issues"])
    ...
    def compare_responses(self, query: str):
        ...
        if not trigger_result["should_trigger"]:
            ...
            console.print("Try a query about Qatar labour law, regulations, or compliance.\n")
            return
    ...
    def _display_metrics(self, baseline: Dict, sanad: Dict):
        ...
        # Latency
        latency_increase = ((sanad["latency"] - baseline["latency"]) / baseline["latency"]) * 100
        table.add_row(
            "Response Time",
