...
class TriggerDetector:
    ...
    def __init__(self, model_name: str = "sentence-transformers/all-MiniLM-L6-v2"):
        ...
        self.reference_embeddings = self.model.encode(
            self.reference_queries, convert_to_numpy=True
        )
    ...
    def use_sanad(self, query: str) -> bool:
        ...
        keyword_match = any(
            keyword in query_lower for keyword in self.verification_keywords
        )
        ...
        phrase_match = any(
            phrase in query_lower for phrase in self.verification_phrases
        )
    ...
    def get_trigger_reason(self, query: str) -> str:
        ...
        # Check keywords
        matched_keywords = [
            keyword for keyword in self.verification_keywords if keyword in query_lower
        ]
        ...
        # Check phrases
        matched_phrases = [
            phrase for phrase in self.verification_phrases if phrase in query_lower
        ]
