...
from .models import (
    User, QueryLog, SourceDocument, UserFeedback, 
    SystemMetrics, AuditLog, DataRetentionPolicy,
    UserCreate, QueryLogCreate, FeedbackCreate, AuditLogCreate
)
...
class QueryRepository(BaseRepository):
    ...
    def get_user_queries(self, user_id: int, limit: int = 50, offset: int = 0) -> List[QueryLog]:
    ...
    def get_system_metrics(self, metric_names: List[str], hours: int = 24) -> List[SystemMetrics]:
    ...
    def cleanup_expired_data(self) -> Dict[str, int]:
        ...
        try:
            ...
            expired_users = (
                ...
                .filter(User.data_retention_until < now)
                .all()
            )
