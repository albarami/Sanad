...
class FAISSRetriever:
    ...
    def __init__(self, index_path: str = "data/index", openai_client: Optional[OpenAI] = None):
        """
    ...
    def _load_category_indices(self) -> None:
        ...
        if category_file.exists():
            ...
            logger.info(f"Loaded category indices for {len(self.category_indices)} categories")
        else:
            logger.warning("No category indices found, using full index for all queries")
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            "categories": list(self.category_indices.keys()) if self.category_indices else [],
