...
from core.enhancer import EnhancementRequest, EnhancementResponse, ResponseEnhancer
...
class TestResponseEnhancer:
    ...
    @pytest.fixture
    def enhancement_request(
        self, sample_passages, sample_agent_scores
    ) -> EnhancementRequest:
    ...
    def test_enhancer_initialization(
        self, mock_llm_class, mock_get_config, mock_config
    ):
    ...
    @patch("core.enhancer.get_config")
    @patch("core.enhancer.BaselineLLM")
    async def test_enhancement_below_threshold(
        self,
        mock_llm_class,
        mock_get_config,
        mock_config,
    ...
    @patch("core.enhancer.get_config")
    @patch("core.enhancer.BaselineLLM")
    async def test_no_enhancement_above_threshold(
        self,
        mock_llm_class,
        mock_get_config,
        mock_config,
    ...
    @patch("core.enhancer.get_config")
    @patch("core.enhancer.BaselineLLM")
    async def test_enhancement_with_insufficient_passages(
        self,
        mock_llm_class,
        mock_get_config,
        mock_config,
    ...
    @patch("core.enhancer.get_config")
    @patch("core.enhancer.BaselineLLM")
    async def test_enhancement_llm_failure(
        self, mock_llm_class, mock_get_config, mock_config, enhancement_request
    ):
    ...
    @patch("core.enhancer.get_config")
    @patch("core.enhancer.BaselineLLM")
    async def test_enhancement_timeout(
        self, mock_llm_class, mock_get_config, mock_config, enhancement_request
    ):
    ...
    def test_domain_query_detection(self, mock_llm_class, mock_get_config, mock_config):
        ...
        assert (
            enhancer._is_domain_relevant("What does the Quran say about charity?")
            is True
        )
